...
class CreateAccount
  ...
  def call
    url = URI("https://api-sandbox.kobana.com.br/v1/bank_billet_accounts")
    ...
    # request["authorization"] = "Bearer #{ENV.fetch('KOBANA_TOKEN')}"

    # response = http.post_form(request, json)


    response = Net::HTTP.post URI("https://api-sandbox.kobana.com.br/v1/bank_billet_accounts"),
                json,
